...
typedef NS_ENUM(NSUInteger, CKPopoverPosition) {
    CKPopoverPositionUp = 1,
    CKPopoverPositionDown,
};

typedef NS_ENUM(NSUInteger, CKPopoverMaskType) {
    CKPopoverMaskTypeBlack,
    CKPopoverMaskTypeNone,
};


@interface CKPopover : UIView
 ...
 */
@property (nonatomic, assign, readonly) CKPopoverPosition popoverPosition;
 ...
 */
@property (nonatomic, assign) CKPopoverMaskType maskType;
